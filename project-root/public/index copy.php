...
<!-- Hero Section -->
<section class="position-relative py-5" style="background: linear-gradient(to right, #f5deb3, #c8cded);">
    <div class="container d-flex align-items-center">
        <!-- Text Section (Left) -->
        <div class="text-center text-white w-100 w-md-6 animate-scroll">
            <h1 class="display-4 fw-semibold mb-4" style="color: #c1703d;">Welcome to SafeSupport</h1>
            ...
            <p class="fs-5 fst-italic" style="color: #ff7f50;">"SafeSupport: We Listen at Your Concern"</p>
            <a href="../public/register.php" class="btn" style="background-color: #c1703d; color: #fff;">Get Started</a>
        </div>
...
<!-- About Us Section -->
<section class="py-5" style="background: linear-gradient(to right, #f5deb3, #c8cded); padding-left: 0; padding-right: 0;">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-4 animate-scroll">
                <div class="card shadow-lg p-4" style="transition: transform 0.3s ease;" onmouseover="this.style.transform='scale(1.05)';" onmouseout="this.style.transform='scale(1)';">
                    ...
                    <a href="/services" class="btn" style="background-color: #c1703d; color: #fff;">Learn More About Our Services</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-5" style="background: linear-gradient(to left, #c8cded, #f5deb3); transition: background 0.5s ease-in-out;">
    <div class="container text-center">
        ...
        <div class="row g-4">
            <div class="col-md-4 animate-scroll">
                <div class="card shadow-lg p-4" style="transition: transform 0.3s ease;" onmouseover="this.style.transform='scale(1.05)';" onmouseout="this.style.transform='scale(1)';">
                    ...
                    <h3 class="fs-4 fw-semibold text-dark">1. Choose Your Counselor</h3>
                    <p class="text-dark">Browse our professional counselors and choose the one that suits your needs.</p>
                </div>
            </div>
            <div class="col-md-4 animate-scroll">
                <div class="card shadow-lg p-4" style="transition: transform 0.3s ease;" onmouseover="this.style.transform='scale(1.05)';" onmouseout="this.style.transform='scale(1)';">
...
<section style="background-color: #c1703d; color: white;" class="py-5 text-center">
    <h2 class="display-5 fw-semibold animate-scroll">Ready to Get Started?</h2>
    <p class="fs-4 animate-scroll animate__delay-1s">Scheduling your first counseling session with SafeSupport is just a few steps away.</p>
    <a href="/register" class="btn" style="background-color: #ff7f50; color: #333333;" class="animate-scroll animate__delay-2s">Register Now</a>
</section>
