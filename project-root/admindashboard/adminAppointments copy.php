...
if (isset($_POST['delete_selected'])) {
    if (isset($_POST['appointments']) && is_array($_POST['appointments'])) {
        ...
        if ($pdo->exec($deleteQuery)) {
            $_SESSION['message'] = "Appointments deleted successfully!";
            $_SESSION['message_type'] = "success"; // Success toast
        } else {
            $_SESSION['message'] = "Error deleting selected appointments.";
            $_SESSION['message_type'] = "danger"; // Error toast
        }
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($appointment['status'] == 'pending'): ?>
                                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#rejectModal<?php echo $appointment['id']; ?>">Reject</button>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
